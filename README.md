...
| [Get-TransportRuleDrops.ps1](exchange/Get-TransportRuleDrops.ps1) | Finds emails dropped or rejected by a specific transport rule; reports sender, recipient, subject, and action |
